          ...
          <div className="flex items-center gap-3">
            ...
            {user ? (
              ...
              <div className="flex items-center gap-3 border-l border-gray-200 pl-4 ml-1 sm:ml-2">
                <Link
                  href="/login"
                  className="inline-flex items-center gap-1.5 bg-gray-900 hover:bg-black text-green px-4 py-2 rounded-xl text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-300"
